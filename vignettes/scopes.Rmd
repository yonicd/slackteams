...
```
slackteams::add_team_interactive(scopes=load_scopes(system.file("scopes.yml", package = "slackteams"),"slackverse"))

```

It is also possible to define custom roles. To do this, define a scopes file, for example "custom_scopes.yml" which can
...
```
slackteams::add_team_interactive(scopes=load_scopes("/path/to/custom_scopes.yml","analyze"))
